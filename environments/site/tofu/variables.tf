...
variable "cluster_image_id" {
    ...
    default = "c34bacd9-6172-4e56-aa5c-1a7085f72fb7" # openhpc-freeipa-250723-1434-27da0bbd, based on upstream @PR717
}
